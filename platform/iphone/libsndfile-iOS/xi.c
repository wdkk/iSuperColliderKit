...
{	XI_PRIVATE	*pxi ;
	...
	psf_binheader_writef (psf, "b", string, (int)strlen (string)) ;
	...
	*/
	...
	psf_binheader_writef (psf, "111111", 128, 0, pxi->sample_flags, 128, 0, (int)strlen (pxi->sample_name)) ;
