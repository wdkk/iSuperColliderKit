...
============================================================*/
	...
	{	if (psf->datalength % pgsm610->blocksize == 0)
			pgsm610->blocks = (int)(psf->datalength / pgsm610->blocksize);   // kengo:
		...
		{	psf_log_printf (psf, "*** Warning : data chunk seems to be truncated.\n") ;
			pgsm610->blocks = (int)(psf->datalength / pgsm610->blocksize + 1);   // kengo:
			} ;
...
{	GSM610_PRIVATE *pgsm610 ;
	...
	newblock	= (int)(offset / pgsm610->samplesperblock);    // kengo:
