...
{	IMA_ADPCM_PRIVATE	*pima ;
	...
	if (psf->datalength % pima->blocksize)
		pima->blocks = (int)(psf->datalength / pima->blocksize + 1);   // kengo:
	else
		pima->blocks = (int)(psf->datalength / pima->blocksize);   // kengo:
...
{	IMA_ADPCM_PRIVATE *pima ;
	...
	newblock	= (int)(offset / pima->samplesperblock);   // kengo:
